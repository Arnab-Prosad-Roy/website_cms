            ...
            <div class="card-body">
              ...
              <form action="{{route('admin.certification.update', $certification->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-12 mb-3">
                  ...
                  <input type="date" class="form-control" name="issue_date" value="{{old('issue_date', $certification->issue_date)}}">
                      @error('issue_date')
                        <span class="text-danger" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <select class="form-select" name="status">
                    ...
                    <option value="1" {{ $certification->status=="1" ? 'selected' : '' }}>Publish</option>
                    <option value="0" {{ $certification->status=="0" ? 'selected' : '' }}>Draft</option>
                  </select>
                      @error('status')
                        <span class="text-danger" role="alert">
                          <strong>{{ $message }}</strong>
