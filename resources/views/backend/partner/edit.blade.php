    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Partner Post</h5>
              ...
              <form action="{{route('admin.partner.update', $partner->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-12 mb-3">
                  ...
                  <input type="text" class="form-control" name="name" value="{{old('name', $partner->name)}}">
                      @error('name')
                ...
                <div class="col-12 mb-3">
                  ...
                  <input type="text" class="form-control" name="site_url" value="{{old('site_url', $partner->site_url)}}">
                      @error('site_url')
                        <span class="text-danger" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <select class="form-select" name="status">
                    ...
                    <option value="0" {{ $partner->status=="1" ? 'selected' : '' }}>Draft</option>
                  </select>
                      @error('status')
                        <span class="text-danger" role="alert">
                          <strong>{{ $message }}</strong>
